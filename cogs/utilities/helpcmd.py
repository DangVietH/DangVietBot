...
# code base on https://github.com/DenverCoder1/dev-pro-tips-bot/blob/main/cogs/help/help_command.py
...
class HelpPageSource(menus.ListPageSource):
    ...
    async def format_page(self, menu, entries):
        ...
        embed = discord.Embed(title="DangVietBot Commands", color=discord.Color.from_rgb(225, 0, 92))
        embed.description = f'Use {prefix}{invoked_with} something for more info on a command or category'
...
class CustomHelp(commands.HelpCommand):
    ...
    async def send_bot_help(self, mapping):
        ...
        pages = ViewMenuPages(ctx=self.context, source=HelpPageSource(self, data), disable_buttons_after=True)
