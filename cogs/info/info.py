...
class Info(commands.Cog):
    ...
    async def whois(self, ctx, user: discord.Member = None):
        ...
        embed.add_field(name="Create at", value=f"<t:{int(ctx.author.created_at.timestamp())}:R>")
        embed.add_field(name="Join at", value=f"<t:{int(ctx.author.joined_at.timestamp())}:R>")
